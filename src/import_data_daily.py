...
if __name__ == '__main__':
    ...
    if 'win' in sys.platform:
        ...
        tkinter.Entry(frame, textvariable=year, width=7).grid(row=2, column=1, padx=(10, 20), pady=10)
        ...
        frame.bind("<Return>", lambda event=None: main(False, day.get(), month.get(), frame))
        root.mainloop()

...
def league_batting_ratios_constructor(year, logger):
    logger.log("\tCalculating batter ratios")
    start_time = time.time()
    keys = []
    final_list = {}
    table = str(BeautifulSoup(urlopen("https://www.baseball-reference.com/leagues/MLB/" + str(year) + "-ratio-batting."
...
# print(league_batting_ratios_constructor(2018, Logger("C:\\Users\\Anthony Raimondo\\PycharmProjects\\baseball-sync\\"

...
def get_hitters(year, team_id, team_key):
    ...
    order_count = [[], [], [], [], [], [], [], [], []]
    try:
        children = str(BeautifulSoup(urlopen("https://www.baseball-reference.com/teams/" + team_key + "/" + str(year)
...
# team_batting_order_constructor(2018, Logger("C:\\Users\\Anthony Raimondo\\PycharmProjects\\baseball-sync\\logs\\"
